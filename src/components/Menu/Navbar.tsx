...
import { BsPersonBadge, BsPersonVideo3, BsPersonVcard, BsBarChart, BsFileArrowUp, BsList } from 'react-icons/bs';
import './Navbar.css';
...
const CustomNavbar = () => {
  ...
  return (
    <Container fluid className="navbar-bar text-white d-flex justify-content-center">
      <Row className="w-75">
        <Col xs={10} lg={4}>
          <Link to="/" className="d-flex justify-content-center align-items-center me-4">
            <div>
              <img src={AdvicesDepartmentIcon} alt="Icon" className="rounded logo-icon" />
            </div>
            <div className="logo-text fw-bold fs-5 text-center">ASESORÍAS FCFM</div>
          </Link>
        </Col>
