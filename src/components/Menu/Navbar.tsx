...
import { BsPersonBadge, BsPersonVideo3, BsPersonVcard, BsBarChart, BsFileArrowUp, BsList, BsPerson } from 'react-icons/bs';
import './Navbar.css';
...
const CustomNavbar = () => {
  ...
  return (
    <Container fluid className="navbar-bar text-white justify-content-center">
      <Row className="w-75">
        <Col xs={10} lg={4}>
          <Link to="/home" className="d-flex justify-content-center align-items-center me-4 logo-container">
            <div>
