...
const AdviseeModal: React.FC<AdviseeModalProps> = ({ show, handleClose, handleSaveChanges, advisee, handleInputChange, errors }) => {
  return (
        ...
        <Form className="p-2">
          ...
          <Form.Group controlId="formGender" className="mb-3">
            ...
            <InputGroup className="shadow-sm">
              ...
              <Form.Control as="select" name="Gender" value={advisee.Gender} onChange={handleInputChange} required isInvalid={!!errors.Gender}>
