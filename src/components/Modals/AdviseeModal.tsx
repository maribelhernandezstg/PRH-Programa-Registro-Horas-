...
const AdviseeModal: React.FC<AdviseeModalProps> = ({ show, handleClose, handleSaveChanges, advisee, handleInputChange, errors, mode }) => {
  return (
    <Modal show={show} onHide={handleClose}>
      <Modal.Header closeButton>
        <Modal.Title>{mode === 'Agregar' ? 'Agregar Asesorado' : 'Editar Asesorado'}</Modal.Title>
      </Modal.Header>
      <Modal.Body>
        <Form className="p-2">
